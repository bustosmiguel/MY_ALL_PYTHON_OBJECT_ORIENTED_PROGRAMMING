...
celular1 = (
    Celular()
)  # esto es un objeto, "este objeto es una instancia de la clase "Celular"(class Celular), es el resultado de haberlo creado en la clase, cuando instanceamos una clase, es un objeto, de la clase (class Celular)
celular2 = Celular()
celular3 = Celular()
celular4 = Celular()
...
class Celular:
    ...
    ):  # Método constructor porque construye la clase
        self.marca = marca
        self.modelo = modelo
        self.camara = camara
...
print(
    celular2.marca
)  # celular2.marca me devuelve la variable, el valor de marca que es IPHONE
...
class Games:
    def __init__(
        self, chess, cards, puzzle, **kwargs
    ):  # **kwargs catches any extra named arguments
        self.chess = chess
        self.cards = cards
        self.puzzle = puzzle
...
class TableGames(Games):
    def __init__(
        self, monopoly, catan, **kwargs
    ):  # First, take what's unique to TableGames
